...
public class MainActivity extends AppCompatActivity {
    ...
    public void buttonDownloadFile(View view) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[]
        ...
        if (requestCode == REQUEST_EXTERNAL_STORAGE) {
            if (grantResults.length == 2 && grantResults[0] == PackageManager.
                    PERMISSION_GRANTED && grantResults[1] ==
                ...
                Toast.makeText(this, "External Storage permission " +
